...
<body>
    ...
    ?>
    <form action ="podioaEguneratu.php" method="GET">
        ...
        <input type="submit" name="eguneratu" id="eguneratu" value="Postua Eguneratu">
    </form>
    ...
    <script>
        ...
        function taulaEguneratu(e) {
            e.preventDefault();
            $.ajax({
                url: "podioaEguneratu.php",
                type: "GET",
                data: { eguneratu: "podioaEguneratu"
